...
sub termux_control{
print "If you executed 'termux-installation.sh' before 'execme.pl', everything is O.K.\n";
Return();
}
print color('yellow');
print"\n\nWelcome to\n";
...
print" 9: About\n";
print" 0: Exit\n";
print" 'chkreg' command: Check requirements if you're in a regular GNU/Linux distribution (without apostrophes).\n";
